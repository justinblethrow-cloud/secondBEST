...
- Add `scripts/kmer_explore.py` for downstream k-mer enrichment, quality calibration, homopolymer phase, motif discovery, replicate reliability, strand asymmetry, substitution spectrum, and risk-ranking reports.
